...
function VaseIcon1({ className }) {
  return (
    <svg className={className} viewBox="0 0 80 100" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
      <path d="M25 35 Q40 20 55 35 L58 70 Q40 88 22 70 Z" strokeLinecap="round" strokeLinejoin="round" />
      <ellipse cx="40" cy="32" rx="18" ry="6" />
      <path d="M32 50 Q40 58 48 50" strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  );
}
...
function VaseIcon2({ className }) {
  return (
    <svg className={className} viewBox="0 0 90 90" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
      <path d="M20 55 Q45 15 70 55 L65 75 Q45 85 25 75 Z" strokeLinecap="round" strokeLinejoin="round" />
      <circle cx="38" cy="48" r="2.5" fill="currentColor" opacity="0.8" />
      <circle cx="52" cy="48" r="2.5" fill="currentColor" opacity="0.8" />
      <path d="M36 58 Q45 64 54 58" strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  );
}
...
export default function BlogPost() {
  ...
  return (
    <div className="blog-post">
      ...
      <main className="blog-post__container">
        ...
        {/* Breathtaking Centered Header */}
        <header className="blog-post__header">
          <span className="blog-card__tag" style={{ background: theme.bg, color: theme.color, borderColor: theme.border }}>
            {category}
          </span>
          <h1 className="blog-post__title" style={titleStyle}>{post.title}</h1>
          
          <div className="blog-post__author-row">
        ...
        {/* Breathtaking Curved Cover Image Card */}
        <div className="blog-post__cover-card">
          <img
        ...
        <section className="blog-content">
          ...
          {/* Tactile Back to Stories CTA at bottom */}
